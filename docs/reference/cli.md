...
| `--codec` | `h264` | `av1` / `h264` / `h265` / `x264` / `x265` / `h264-vaapi` / `h265-vaapi` / `h264-videotoolbox` / `h265-videotoolbox` / `h264-qsv` / `h265-qsv`. The first three are self-contained (rav1e/openh264); the rest shell out to system ffmpeg (runtime-detected, no cargo dep). See [Codecs](codecs.md). |
